...
tryCatch({
  #Read all necessary files:
      #Raw results
  raw <- read_tsv(paste0(home, "/WorkDir/", subdir, "/DEG_results/", subdir, "-vs_DEG.out"), col_names = 1:12)
      #Protein IDs
  ...
  write_tsv(AllResults, paste0(home, "/WorkDir/", subdir,"/Final_results/DEG-", subdir, "-final.tsv"))
  rm(list = ls())
}, 
